...
import { authenticate, requireManagement, requireMistakeWrite, AuthRequest } from '../middleware/auth'
...
router.post('/bulk', authenticate, requireMistakeWrite, async (req: AuthRequest, res: Response) => {
...
router.post('/', authenticate, requireMistakeWrite, async (req: AuthRequest, res: Response) => {
...
router.put('/:id', authenticate, requireMistakeWrite, async (req: AuthRequest, res: Response) => {
...
router.delete('/:id', authenticate, requireMistakeWrite, async (req: AuthRequest, res: Response) => {
